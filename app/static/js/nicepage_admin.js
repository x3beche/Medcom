! function(t) {
	...
	}, e.p = "/Content/BundledScripts/", e(e.s = 8389)
}({
	108: function(t, e, i) {
		"use strict";
	...
	181: function(t, e, i) {
		...
		(function(t) {
			...
			}, i(287), e.setImmediate = "undefined" != typeof self && self.setImmediate || void 0 !== t && t.setImmediate || this && this.setImmediate, e.clearImmediate = "undefined" != typeof self && self.clearImmediate || void 0 !== t && t.clearImmediate || this && this.clearImmediate
		}).call(e, i(26))
	},
	194: function(t, e, i) {
		"use strict";
	...
	316: function(t, e, i) {
		...
		i(317), n.prototype.initialize = function t(e) {
	...
	8391: function(t, e, i) {
		"use strict";
		i(8392), i(8393), i(269), i(8394), i(8395), i(8396), i(8397), i(527), i(539), i(8398), i(8406), i(8407), i(8409), i(8411), i(8412), i(8413), i(8414), i(354), i(8415), i(8420), i(8421), i(8423), i(8424), i(8426), i(8428), i(8429), i(8431), i(8432), i(8433), i(8434), i(8435)
	},
	8392: function(t, e, i) {
		"use strict";
				...
				submit: function(i) {
					...
					o.ajax({
						...
						if (data && (data.success || data.ok || "success" === t)){
							...
							if (data.info == "Changed") { location.reload(); }
							
							try { document.getElementById("success_message").textContent=data.info; } catch (error) { }
							try { document.getElementById("success_message-1").textContent=data.info; } catch (error) { }
							try { document.getElementById("success_message-2").textContent=data.info; } catch (error) { }
							try { document.getElementById("success_message-3").textContent=data.info; } catch (error) { }
							try { document.getElementById("success_message-4").textContent=data.info; } catch (error) { }
							try { document.getElementById("success_message-5").textContent=data.info; } catch (error) { }
							try { document.getElementById("success_message-6").textContent=data.info; } catch (error) { }
							try { document.getElementById("success_message-7").textContent=data.info; } catch (error) { }
							try { document.getElementById("success_message-8").textContent=data.info; } catch (error) { }
							try { document.getElementById("success_message-9").textContent=data.info; } catch (error) { }
							try { document.getElementById("success_message-10").textContent=data.info; } catch (error) { }
							try { document.getElementById("success_message-11").textContent=data.info; } catch (error) { }

                            if (FormMessage.showSuccess(form), a) window.location.replace(a);
							else e(form);
                            
							if(data.info == "Match found, you are redirected to user's page."){
							setTimeout(function() {  window.location.href = "@" + data.redirect; }, 1500);}
							
							if (data.info == "Successfully Sent") {
							setTimeout(function() {  location.reload(); }, 1000);}

							if(data.info == "Login Success"){
							setTimeout(function() {  window.location.href = "/dashboard/"; }, 1000);}
                            
							if(data.info == "We have sent an e-mail to reset your password."){
							setTimeout(function() {  document.getElementById("success_message").textContent="We direct you to the home page.";  }, 2000);
                            setTimeout(function() {  window.location.href = "/login/"; }, 4000);}

							if(data.info == "Password changed successfully."){
							setTimeout(function() {  document.getElementById("success_message").textContent="We direct you to the dashboard";  }, 2000);
						...
						try { document.getElementById("error_message").textContent=data.responseJSON.error; } catch (error) { }
						try { document.getElementById("error_message-1").textContent=data.responseJSON.error; } catch (error) { }
						try { document.getElementById("error_message-2").textContent=data.responseJSON.error; } catch (error) { }
						try { document.getElementById("error_message-3").textContent=data.responseJSON.error; } catch (error) { }
						try { document.getElementById("error_message-4").textContent=data.responseJSON.error; } catch (error) { }
						try { document.getElementById("error_message-5").textContent=data.responseJSON.error; } catch (error) { }
						try { document.getElementById("error_message-6").textContent=data.responseJSON.error; } catch (error) { }
						try { document.getElementById("error_message-7").textContent=data.responseJSON.error; } catch (error) { }
						try { document.getElementById("error_message-8").textContent=data.responseJSON.error; } catch (error) { }
						try { document.getElementById("error_message-9").textContent=data.responseJSON.error; } catch (error) { }
						try { document.getElementById("error_message-10").textContent=data.responseJSON.error; } catch (error) { }
						try { document.getElementById("error_message-11").textContent=data.responseJSON.error; } catch (error) { }
						FormMessage.showError(form);
					}))
				},
				click: function(t) {
	...
	8407: function(t, e, i) {
		"use strict";
		var n = i(9);
		i(8408), n(window).on("load", (function() {
			var t;
	...
	8409: function(t, e, i) {
		...
		i(8410), n.prototype.initialize = function t(e) {
			if (!this.waypoint)
